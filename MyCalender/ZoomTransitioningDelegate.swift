...
//func zoomingImageView(transition: ZoomTransitioningDelegate) // zoomingImageView(transition: xxx)
//func zoomingImageView(_ transition: ZoomTransitioningDelegate) // zoomingImageView(xxx)
//func zoomingImageView(for transition: ZoomTransitioningDelegate) // zoomingImageView(for: xxx)
